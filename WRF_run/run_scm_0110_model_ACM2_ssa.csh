...
#PBS -N run_scm_0110_ACM2_ssa
#PBS -q big

#PBS -l nodes=1:ppn=1
#PBS -l walltime=100:00:00
#PBS -o /home/wjd/WRF_scm/scripts/run_scm_0110_model_ACM2_ssa.log
#PBS -j oe
...
set casename = "0110_12Z_model_ACM2_ssa"
...
wrf.exe >& check_j${jdayin}_ssa${ssa}.log

#-- rename output files

set outfile = ${file}"Z_${casename}_j${jdayin}_ssa${ssa}"
cp $infile $outfile
