...
#PBS -N run_scm_0101_model_ACM2
#PBS -q big

#PBS -l nodes=1:ppn=1
#PBS -l walltime=100:00:00
#PBS -o /home/wjd/WRF_scm/scripts/run_scm_0101_model_ACM2.log
#PBS -j oe

set echo ON

set casename = "0101_12Z_model_ACM2"
...
#-- cope namelist
ln -sf $INPUTDIR/namelist.input.bj.0101_12Z.ACM2 namelist.input

ln -sf $MODELDIR/main/ideal.exe ideal.exe
ideal.exe >& ideal.log

ln -sf $INPUTDIR/wrfinput_d01_2013010112Z_model wrfinput_d01
cp wrfinput_d01 wrfinput_d01_2013010112Z_model
