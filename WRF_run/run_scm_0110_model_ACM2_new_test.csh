...
#PBS -N run_scm_0110_ACM2_new_test
#PBS -q big

#PBS -l nodes=1:ppn=1
#PBS -l walltime=100:00:00
#PBS -o /home/wjd/WRF_scm/scripts/run_scm_0110_model_ACM2_new_test.log
#PBS -j oe

set echo ON
set BASEDIR = /home/wjd/WRF_scm/scripts
set INPUTDIR = $BASEDIR/../em_scm_xy
set MODELDIR = $BASEDIR/../WRFV3.8.1_test
set casename = "0110_12Z_model_ACM2_new_test"
...
ln -sf $INPUTDIR/input_cloud_test.txt			                input_cloud.txt
ln -sf $INPUTDIR/input_cloud_layer.txt                                  input_cloud_layer.txt
