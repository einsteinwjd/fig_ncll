...
#PBS -N run_scm_0101_ACM2_aod_th0110_q0110
#PBS -q big

#PBS -l nodes=1:ppn=1
#PBS -l walltime=100:00:00
#PBS -o /home/wjd/WRF_scm/scripts/run_scm_0101_model_ACM2_aod_th0110_q0110.log
#PBS -j oe

set echo ON
set BASEDIR = /home/wjd/WRF_scm/scripts
set INPUTDIR = $BASEDIR/../em_scm_xy
set MODELDIR = $BASEDIR/../WRFV3.8.1_aod
set casename = "0101_12Z_th0110_q0110_ACM2_aod"
...
ln -sf $INPUTDIR/input/input_sounding_bj20130101_th0110_q0110_12Z.txt   input_sounding_bj2013winter
ln -sf $INPUTDIR/input_cloud.txt                                        input_cloud.txt
ln -sf $INPUTDIR/input_cloud_layer_high_cloud_layer50.txt                                  input_cloud_layer.txt
