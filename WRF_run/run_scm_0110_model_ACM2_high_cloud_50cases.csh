...
#PBS -N run_scm_0110_ACM2_high_cloud_case50
#PBS -q big

#PBS -l nodes=1:ppn=1
#PBS -l walltime=100:00:00
#PBS -o /home/wjd/WRF_scm/scripts/run_scm_0110_model_ACM2_high_cloud_case50.log
#PBS -j oe
...
set casename = "0110_12Z_model_ACM2_cloud_case50"
...
wrf.exe >& check_j${jdayin}_aod${qc_inn}.log

#-- rename output files

set outfile = ${file}"Z_${casename}_j${jdayin}_cloud${qc_inn}"
cp $infile $outfile

echo "end of case"

@qc_inn = `expr $qc_inn + 0.00001`
