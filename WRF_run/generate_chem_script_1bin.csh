...
sed "s/SDAY/$Day/g; s/CITY/${cities}/g"  run_scm_chem.temple.inputPM_1bin.csh > ./run_1bin/run_scm_multidays_chem_profile_${cities}_$Day.csh 
#sed "s/eday/$day_end[$i]/g"  ./test/namelist.input.tmp > ./test/namelist.input.201701${Day}  

qsub ./run_1bin/run_scm_multidays_chem_profile_${cities}_$Day.csh
