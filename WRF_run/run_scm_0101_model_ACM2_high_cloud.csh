...
#PBS -N run_scm_0101_ACM2_cloud
#PBS -q big

#PBS -l nodes=1:ppn=1
#PBS -l walltime=100:00:00
#PBS -o /home/wjd/WRF_scm/scripts/run_scm_0101_model_ACM2_cloud.log
#PBS -j oe
...
set casename = "0101_12Z_ACM2_high_cloud"
...
set outfile = ${file}"Z_${casename}_j${jdayin}_qc${qc_in}"
cp $infile $outfile
