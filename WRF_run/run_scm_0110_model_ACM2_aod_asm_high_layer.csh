...
#PBS -N run_scm_0110_ACM2_aod_asm_layer40
#PBS -q big

#PBS -l nodes=1:ppn=1
#PBS -l walltime=100:00:00
#PBS -o /home/wjd/WRF_scm/scripts/run_scm_0110_model_ACM2_aod_asm_layer40.log
#PBS -j oe

set echo ON
set BASEDIR = /home/wjd/WRF_scm/scripts
set INPUTDIR = $BASEDIR/../em_scm_xy
set MODELDIR = $BASEDIR/../WRFV3.8.1_aod_high_layer
set casename = "0110_12Z_model_ACM2_aod_asm_high_layer"
...
set outfile = ${file}"Z_${casename}_j${jdayin}_aod${aodin}_qc${qc_in}_asm${asmaerin}"
cp $infile $outfile
