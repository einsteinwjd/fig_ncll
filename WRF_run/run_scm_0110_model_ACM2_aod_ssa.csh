...
#PBS -N run_scm_0110_ACM2_aod_ssa
#PBS -q big

#PBS -l nodes=1:ppn=1
#PBS -l walltime=100:00:00
#PBS -o /home/wjd/WRF_scm/scripts/run_scm_0110_model_ACM2_aod_ssa.log
#PBS -j oe
...
set casename = "0110_12Z_model_ACM2_aod_ssa"
...
#foreach aodin("1.0")
foreach ssa("1.0" "0.99" "0.98" "0.97" "0.96" "0.95" "0.94" "0.93" "0.92" "0.91" "0.90" "0.89" "0.88" "0.87" "0.86" "0.85" "0.84" "0.83" "0.82" "0.81" "0.80")
#foreach ssa("0.95")
foreach qc_in("0.0")
