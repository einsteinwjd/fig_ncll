...
sed "s/SDAY/$Day/g; s/CITY/${cities}/g"  run_scm_multidays_model_ACM2_aod_layer_profile_temple.csh > ./run/run_scm_multidays_profile_${cities}_$Day.csh 
#sed "s/eday/$day_end[$i]/g"  ./test/namelist.input.tmp > ./test/namelist.input.201701${Day}  

qsub ./run/run_scm_multidays_profile_${cities}_$Day.csh
