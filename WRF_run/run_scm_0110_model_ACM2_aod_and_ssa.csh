...
#PBS -N run_scm_0110_ACM2_aod_and_ssa
#PBS -q big

#PBS -l nodes=1:ppn=1
#PBS -l walltime=100:00:00
#PBS -o /home/wjd/WRF_scm/scripts/run_scm_0110_model_ACM2_aod_and_ssa.log
#PBS -j oe
...
set casename = "0110_12Z_model_ACM2_aod_and_ssa"
...
set outfile = ${file}"Z_${casename}_j${jdayin}_aod${aodin}_ssa${ssa}"
cp $infile $outfile
